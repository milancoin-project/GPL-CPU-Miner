...
ACLOCAL = ${SHELL} /v/bibibi/src/cpuminer/missing --run aclocal-1.11
ALLOCA = 
AMTAR = ${SHELL} /v/bibibi/src/cpuminer/missing --run tar
AUTOCONF = ${SHELL} /v/bibibi/src/cpuminer/missing --run autoconf
AUTOHEADER = ${SHELL} /v/bibibi/src/cpuminer/missing --run autoheader
AUTOMAKE = ${SHELL} /v/bibibi/src/cpuminer/missing --run automake-1.11
AWK = gawk
...
LTLIBOBJS = 
MAINT = #
MAKEINFO = ${SHELL} /v/bibibi/src/cpuminer/missing --run makeinfo
MKDIR_P = /bin/mkdir -p
OBJEXT = o
PACKAGE = cpuminer
PACKAGE_BUGREPORT = 
...
VERSION = 2.4.0
WS2_LIBS = -lws2_32
abs_builddir = /v/bibibi/src/cpuminer
abs_srcdir = /v/bibibi/src/cpuminer
abs_top_builddir = /v/bibibi/src/cpuminer
abs_top_srcdir = /v/bibibi/src/cpuminer
ac_ct_CC = 
am__include = include
am__leading_dot = .
am__quote = 
...
install_sh = ${SHELL} /v/bibibi/src/cpuminer/install-sh
