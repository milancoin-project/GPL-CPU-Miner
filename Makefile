...
target_triplet = i386-pc-mingw32
...
ACLOCAL = ${SHELL} /v/bibibi/src/GPL-CPU-miner/missing --run aclocal-1.11
ALLOCA = 
AMTAR = ${SHELL} /v/bibibi/src/GPL-CPU-miner/missing --run tar
AUTOCONF = ${SHELL} /v/bibibi/src/GPL-CPU-miner/missing --run autoconf
AUTOHEADER = ${SHELL} /v/bibibi/src/GPL-CPU-miner/missing --run autoheader
AUTOMAKE = ${SHELL} /v/bibibi/src/GPL-CPU-miner/missing --run automake-1.11
AWK = gawk
CC = mingw32-gcc -std=gnu99
CCAS = mingw32-gcc -std=gnu99
CCASDEPMODE = depmode=gcc3
CCASFLAGS = -g -O2
CCDEPMODE = depmode=gcc3
CFLAGS = -g -O2
CPP = mingw32-gcc -std=gnu99 -E
CPPFLAGS = 
CYGPATH_W = cygpath -w
DEFS = -DHAVE_CONFIG_H
DEPDIR = .deps
...
LTLIBOBJS = 
MAINT = #
MAKEINFO = ${SHELL} /v/bibibi/src/GPL-CPU-miner/missing --run makeinfo
MKDIR_P = /bin/mkdir -p
OBJEXT = o
PACKAGE = cpuminer
PACKAGE_BUGREPORT = 
PACKAGE_NAME = cpuminer
PACKAGE_STRING = cpuminer 2.4.0
...
VERSION = 2.4.0
WS2_LIBS = -lws2_32
abs_builddir = /v/bibibi/src/GPL-CPU-miner
abs_srcdir = /v/bibibi/src/GPL-CPU-miner
abs_top_builddir = /v/bibibi/src/GPL-CPU-miner
abs_top_srcdir = /v/bibibi/src/GPL-CPU-miner
ac_ct_CC = 
am__include = include
am__leading_dot = .
am__quote = 
...
install_sh = ${SHELL} /v/bibibi/src/GPL-CPU-miner/install-sh
...
minerd_LDADD = lib/libcurl.dll.a compat/jansson/libjansson.a -lpthread -lws2_32
minerd_CPPFLAGS = -DSCRYPT_KECCAK512 -DSCRYPT_CHACHA -DSCRYPT_CHOOSE_COMPILETIME
...
include ./$(DEPDIR)/minerd-scrypt-jane.Po
...
minerd-scrypt-jane.o: scrypt-jane.c
	$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(minerd_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -MT minerd-scrypt-jane.o -MD -MP -MF $(DEPDIR)/minerd-scrypt-jane.Tpo -c -o minerd-scrypt-jane.o `test -f 'scrypt-jane.c' || echo '$(srcdir)/'`scrypt-jane.c
	$(am__mv) $(DEPDIR)/minerd-scrypt-jane.Tpo $(DEPDIR)/minerd-scrypt-jane.Po
#	source='scrypt-jane.c' object='minerd-scrypt-jane.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(minerd_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -c -o minerd-scrypt-jane.o `test -f 'scrypt-jane.c' || echo '$(srcdir)/'`scrypt-jane.c

minerd-scrypt-jane.obj: scrypt-jane.c
	$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(minerd_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -MT minerd-scrypt-jane.obj -MD -MP -MF $(DEPDIR)/minerd-scrypt-jane.Tpo -c -o minerd-scrypt-jane.obj `if test -f 'scrypt-jane.c'; then $(CYGPATH_W) 'scrypt-jane.c'; else $(CYGPATH_W) '$(srcdir)/scrypt-jane.c'; fi`
	$(am__mv) $(DEPDIR)/minerd-scrypt-jane.Tpo $(DEPDIR)/minerd-scrypt-jane.Po
#	source='scrypt-jane.c' object='minerd-scrypt-jane.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(minerd_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -c -o minerd-scrypt-jane.obj `if test -f 'scrypt-jane.c'; then $(CYGPATH_W) 'scrypt-jane.c'; else $(CYGPATH_W) '$(srcdir)/scrypt-jane.c'; fi`
